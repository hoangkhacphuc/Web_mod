...
<html>
	<head>
        ...
        <link rel="stylesheet" type="text/css" href="locmem.css">
	...
	<body>
        ...
        <div class="user_content">
                        ...
                        echo '<div class="title">ADMIN</div>
                                <div class="content">
                                    <ul>
                                        ...
                                        <li><a href="xoamem.php" style="color: #65b1ff;"><i class="fa fa-user-times"></i>&nbsp;&nbsp;Xóa member</a></li>
                                    </ul>
                                </div>';
                    }
                ?>
            ...
            <div class="conn_user">
                <div class="title">XÓA MEMBER</div>
                <div class="line"></div>
                <div class="list">
                    <table>
                        <tr>
                            <td class='title_con'>User : </td>
                            <td class="item">
                                <input type="text" placeholder="Tên đăng nhập ..." id="puser" class="getid">
                                <button onclick="getuser()" class="btn-getid"><i class="fa fa-download"></i>&nbsp;Get</button>
                            </td>
                        </tr>
                        <tr id='searchmem'></tr>
                    </table>
