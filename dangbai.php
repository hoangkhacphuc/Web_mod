        ...
        <div class="user_content">
                ...
                <?php
                    if (isset($_SESSION['loai']) && $_SESSION['loai'] == 1)
                    {
                        echo '<div class="title">ADMIN</div>
                                <div class="content">
                                    <ul>
                                        <li><a href="dangbai.php" style="color: #65b1ff;"><i class="fa fa-file-code-o"></i>&nbsp;&nbsp;Bài viết mới</a></li>
            ...
            <div class="conn_user">
                ...
                <div class="list">
                    ...
                    <button onclick="dangbai()"><i class="fa fa-paper-plane-o"></i>&nbsp;Đăng Bài</button>
                </div>
            </div>
        </div>
    </body>
